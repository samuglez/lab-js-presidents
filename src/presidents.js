...
function getNames(presidentsArr) {return presidentsArr.map(president => president.name)}
...
function getDemocraticPresidents(presidentsArr) {return presidentsArr.filter(president => president.party === "Democratic")}
...
function  countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((totalYears, president) =>{
    if (president.leftOffice != null) {
      const yearsOffice = president.leftOffice - president.tookOffice
      return totalYears + yearsOffice
    }
    return totalYears
  }, 0)
}
...
function sortPresidentsByBirthYear(presidentsArr) {
  return presidentsArr.sort((a,b) =>{ return a.birthYear - b.birthYear})
}
...
// console.log(getPresidentsBornAfter(presidents,1900));
